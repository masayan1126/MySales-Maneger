...
@section('content')
  <div class="mt-4 w-100 card mx-auto max-width-500">
    ...
    <div class="card-body">
      <form action="sale-update" method="post" enctype="multipart/form-data" id="form">
      @csrf
      <div class="form-group">
        <input name="check[]" type="hidden" value="{{ $product_id }}">
        <label class="d-block p-1" for="imagefile">商品名：</label>
        <input class="d-block p-1 form-control" type="text" id="imagefile" name="productNumber" size="50" value="{{ $product_numbers }}"/>
